...
async function run() {
  ...
  const endpointsToTest = [
    'https://api.wisphub.net/api/pago/',
    'https://api.wisphub.net/api/pagos/',
    'https://api.wisphub.net/api/caja/pagos/',
    'https://api.wisphub.net/api/finanzas/pagos/',
    'https://api.wisphub.net/api/facturas/pagar/',
    'https://api.wisphub.net/api/facturas/pago/',
    'https://api.wisphub.net/api/reportar-pago/'
  ];
  ...
  for (const url of endpointsToTest) {
    try {
      ...
      if (e.response && e.response.status !== 404) {
         console.log("Found valid endpoint! Status:", e.response.status);
